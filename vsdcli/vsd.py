...
def main(argv=sys.argv):
    ...
    list_parser.add_argument('target', help="Name of the VSD object (See command `objects` to list all objects name)")
    ...
    show_parser.add_argument('target', help="Name of the object to show (See command `objects` to list all objects name)")
    ...
    create_parser.add_argument('target', help='Name of the object to create (See command `objects` to list all objects name)')
    ...
    update_parser.add_argument('target', help='Name of the object to update (See command `objects` to list all objects name)')
    ...
    delete_parser.add_argument('target', help='Name of the object to update (See command `objects` to list all objects name)')
